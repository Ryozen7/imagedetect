...
export default function History() {
    ...
    return (
        ...
        <div className="flex items-center justify-center h-[70vh] w-full bg-gray-100">
            <div className='bg-gray-200 shadow-xl w-[95%] h-[98%] rounded-md p-5'>
                <div className='w-full h-full flex flex-col'>
                    ...
                    <div className='w-full flex flex-col justify-start text-lg font-medium'>
                        ...
                        <div className='overflow-y-auto'>
                            {state.imageHistory?.length > 0 && state.imageHistory.map(image => {
                                return (
                                    <div className='w-full border-b-2 border-gray-300 flex flex-col'>
